// app.controller('draftsController', ['$scope', '$location',function($scope, $location){
app.controller('draftsController', ['$scope',function($scope){
    // $scope.getDraft     = getDraft(),
    // $scope.go = function (path) {
    //     $location.path( path );
    // };

    console.log('draftsController');
